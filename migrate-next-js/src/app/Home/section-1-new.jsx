        ...
        >
            <div className="gap-16 items-center py-8 px-4 mx-auto max-w-screen-xl lg:grid lg:grid-cols-2 lg:py-16 lg:px-6">
                <div className="font-light text-black sm:text-lg">
                    <h1 className={`mb-0 ${styles.heading2}`}>
                        {sectionTitle}
                    </h1>
                    <p className={`${styles.paragraph} mb-4`}>
                        Sertifikasi FRAC adalah sertifikasi profesional dalam manajemen risiko untuk perusahaan. Tujuan dari sertifikasi FRAC adalah memberikan gelar profesional kepada para ahli dan manajer manajemen risiko yang memiliki keahlian dalam menangani risiko. Program sertifikasi ini memiliki kurikulum khusus dan skema sertifikasi. Memperoleh sertifikasi FRAC dapat membantu individu menunjukkan pengetahuan dan keahlian mereka dalam manajemen risiko, yang dapat membuka
                        peluang kemajuan karier dan meningkatkan kredibilitas di bidang tersebut.
                    </p>
                </div>
