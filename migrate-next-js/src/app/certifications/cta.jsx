    ...
    >
      ...
      >
        ...
        >
          ...
          <span class="text-sm font-medium">Become rofessional</span>
          <svg
            class="ml-2 w-5 h-5"
            fill="currentColor"
            viewBox="0 0 20 20"
        ...
        <h1
          class={`${styles.heading2} text-black mb-4 text-4xl  tracking-tight `}
        >
        ...
        <div class="flex flex-col mb-8 lg:mb-16 space-y-4 sm:flex-row sm:justify-center sm:space-y-0 sm:space-x-4">
          ...
          <a
            ...
            target="_blank"
            class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-black rounded-lg border border-black-600 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 white:text-black white:border-gray-700 white:hover:bg-gray-700 white:focus:ring-gray-800"
          >
            <svg
