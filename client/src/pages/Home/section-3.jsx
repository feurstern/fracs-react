  ...
  return (
    <section className={` mt-[10px]`}>
        ...
        <div id='table-scheme' className={`${styles.flexStart2} font-poppins text-[18px]`}>
         <table className='border-[3.5px] border-l-[3.5px]  border-black table-fixed'>
            <thead>
              <tr>
            ...
            <tbody className='w-[20px]'>
                <tr className=''>
                 ...
                 <tr>
                    <td>10</td>
                    <td>The candidate is compulsory to have a good sight, not blidnly, and the candidate is able to use computer.</td>
                </tr>
            </tbody>
         </table>
        </div>
