...
const Section6 = ({content,name,title, img}) =>(
    <div className="flex justify-between flex-col px-10 py-12 rounded-[20px] max-w-[360px] md:mr-10 sm:mr-5 mr-0 my-5 feed-back-card">
     ...
     <div className='flex flex-row'>
       <img src={img} alt='people' className='w-[48px] h-[48px] rounded-full' />
